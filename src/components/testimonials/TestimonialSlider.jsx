...
const TestimonialSlider = () => {
  ...
  return (
    <div className="py-20">
        ...
        <h1 className="text-black font-bold text-center text-4xl uppercase   ">What Our Clients Say ?</h1>
...
<div className="flex flex-col w-3/4 mx-auto rounded-full justify-center items-center space-y-8">
  ...
  <div className="w-36">
  <img className="w-full  rounded-full" src={n.image} alt="" />
  </div>
    <h1 className="text-xl text-gray-600 font-bold">{n.feedback}</h1>
